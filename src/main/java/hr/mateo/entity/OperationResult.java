...
public class OperationResult implements Serializable, Constants {
    ...
    public static final Coder<OperationResult> CODER =
            new CustomCoder<OperationResult>() {
                @Override
    ...
    public OperationResult(String result, long numberOfRecords, long processingTimeStart, long processingTimeEnd, long kafkaInputTime) {
        this.result = result;
