...
public class Accum implements Serializable, Constants {
    ...
    public static final Coder<Accum> CODER =
            new CustomCoder<Accum>() {
                @Override
    ...
    public double getNumberOfRecords() { return numberOfRecords; }

    public void setNumberOfRecords(double numberOfRecords) { this.numberOfRecords = numberOfRecords; }
    ...
    public double getKafkaInputTime() { return kafkaInputTime; }

    public void setKafkaInputTime(double kafkaInputTime) { this.kafkaInputTime = kafkaInputTime; }
