...
public class SensorReading implements Serializable, Constants {
    ...
    public static final Coder<SensorReading> CODER =
            new CustomCoder<SensorReading>() {
                @Override
    ...
    public void setMeasurementPeriodType(String measurementPeriodType) { this.measurementPeriodType = measurementPeriodType; }
    ...
    public long getKafkaInputTime() { return kafkaInputTime; }

    public void setKafkaInputTime(long kafkaInputTime) { this.kafkaInputTime = kafkaInputTime; }
